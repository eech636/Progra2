<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarUsuario.aspx.cs" Inherits="SistemaInventarioVentas.Usuarios.EliminarUsuario" %>
        ...
        <div class="col-11 col-md-8 rounded shadow p-3 p-sm-4">
            <div>
                ...
                <div class="overflow-auto ps-3 pe-3">
                    <asp:GridView ID="GvUsuario" runat="server" CssClass="table table-light table-bordered table-hover text-center"></asp:GridView>
                </div>
